...
import { Packet, State, toBuffer, fromBuffer,
    ServerboundHandshakePacket, ServerboundLoginStartPacket } from "../common/network/packets";
...
export class ConnectClient {
    ...
    public send(packet: Packet): void {
        this.socket.send(toBuffer(packet));
    }

    public connect(name: string, playerUUID?: string) {
